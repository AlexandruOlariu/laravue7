...
class StateTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $event = \Phake::mock('App\piece\stagehandfsm\src\Event\TransitionEventInterface');
    ...
    {
        $event1 = \Phake::mock('App\piece\stagehandfsm\src\Event\TransitionEventInterface');
        \Phake::when($event1)->getEventId()->thenReturn('bar');
        \Phake::when($event1)->isEndEvent()->thenReturn(false);
        $event2 = \Phake::mock('App\piece\stagehandfsm\src\Event\TransitionEventInterface');
