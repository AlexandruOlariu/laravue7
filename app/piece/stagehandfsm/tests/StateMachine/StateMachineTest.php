...
namespace App\piece\stagehandfsm\src\StateMachine;

use App\piece\stagehandfsm\src\Event\EventInterface;
...
class StateMachineTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function dispatchesSystemEventsToListenersIfTheEventDispatcherHasBeenSet()
    {
        ...
        $this->assertThat($events[0]->getEvent(), $this->isInstanceOf('App\piece\stagehandfsm\src\Event\TransitionEventInterface'));
        ...
        $this->assertThat($events[2]->getEvent(), $this->isInstanceOf('App\piece\stagehandfsm\src\Event\TransitionEventInterface'));
        ...
        $this->assertThat($events[3]->getEvent(), $this->isInstanceOf('App\piece\stagehandfsm\src\Event\EventInterface'));
        ...
        $this->assertThat($events[4]->getEvent(), $this->isInstanceOf('App\piece\stagehandfsm\src\Event\EventInterface'));
        ...
        $this->assertThat($events[5]->getEvent(), $this->isInstanceOf('App\piece\stagehandfsm\src\Event\TransitionEventInterface'));
        ...
        $this->assertThat($events[6]->getEvent(), $this->isInstanceOf('App\piece\stagehandfsm\src\Event\EventInterface'));
        ...
        $this->assertThat($events[7]->getEvent(), $this->isInstanceOf('App\piece\stagehandfsm\src\Event\TransitionEventInterface'));
        ...
        $this->assertThat($events[8]->getEvent(), $this->isInstanceOf('App\piece\stagehandfsm\src\Event\EventInterface'));
        ...
        $this->assertThat($events[9]->getEvent(), $this->isInstanceOf('App\piece\stagehandfsm\src\Event\EventInterface'));
