...
namespace App\piece\stagehandfsm\src\Event;
...
class TransitionEventTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function isNotAnEndEventIfTheNextStateIsNotSet()
    {
        ...
        $event->setNextState(\Phake::mock('App\piece\stagehandfsm\src\State\StateInterface'));
    ...
    {
        $state = \Phake::mock('App\piece\stagehandfsm\src\State\StateInterface');
