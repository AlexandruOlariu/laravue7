...
[![Build Status](https://travis-ci.org/piece/stagehand-fsm.svg?branch=2.6)](https://travis-ci.org/piece/stagehand-fsm)
...
```
composer require piece/stagehand-fsm "~2.6@dev"
```
